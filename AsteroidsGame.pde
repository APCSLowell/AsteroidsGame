...
public void draw() 
{
	...
	}else if(start)
	{
		...
		if(missSet)
		{
			tarX=rockBottom.get(missShip).getX()-25;
			tarY=rockBottom.get(missShip).getY()-25;
			selectTar=false;
			fireHome=true;
		}
		if(fireHome)
		{
			float turning=asin(Math.abs((tarY+25)-(miss.getY()))/(dist(miss.getX(),miss.getY(),tarX+25,tarY+25)));
			...
			if(tarX>miss.getX()&&tarY>miss.getY())
			{
				...
				miss.setPointDirection((int)a);
				println("top right, a-value: "+a+", angle: "+miss.getPointDirection());
			}
...
public void keyPressed()
{
	switch (key){
		...
		case 'a':
			...
			println("ship angle is "+ship.getPointDirection()+" hjdshjkdfshjsfdhjgdsghjkdshgjkhgjkdafs");
		break;
		case 's':
			shipAccel(-1);
		break;
	...
	if(start)
	{
		if(home)
		{
			...
			for(int m=0;m<rockBottom.size();m++)
			{
				...
				if(mouseX>=rockBottom.get(m).getX()-10&&mouseX<=rockBottom.get(m).getX()+10&&mouseY>=rockBottom.get(m).getY()-10&&mouseY<=rockBottom.get(m).getY()+10)
				{
					missSet=true;
					missShip=m;
					break;
...
// {
//        ~
//        miss.setPointDirection=a;
// }
// If(miss.getX()>tarX&&tarY>miss.getY())
// {
//        ~
//        miss.setPointDirection()=(90-deg(a))+90;
// }
// If(miss.getX()>tarX&&miss.getY()>tarY)
// {
//        ~
//        miss.setPointDirection()=deg(a)+180;
// }
// If(tarX>miss.getX()&&miss.getY()>tarY)
// {
//        ~
//        miss.setPointDirection()=(90-deg(a))+270;
// }
...
// 					for(int t=0;t<rockBottom.size();t++)
// 					{
// 						image(boxTar, rockBottom.get(t).getX()-25, rockBottom.get(t).getY()-25, 50, 50);
// 					}
// 				}else
// 				{
// 					miss.setPointDirection((int)ship.getPointDirection());
...
// void missSpeed(int x)
// {
// 	println("speed(before): "+miss.speed);
// 	miss.speed=0;
// 	miss.setDirectionX(0);
// 	miss.setDirectionY(0);
// 	miss.accelerate(5);
// 	println("speed(after): "+miss.speed);
// 	println("start moving again");
// }
// void bossSet()
// {
// 	if(bossCount<10&&bossGame)
...
// 				{*/
// 			tarX=mouseX-25;//rockBottom.get(m).getX()-25;
// 			tarY=mouseY-25;//rockBottom.get(m).getY()-25;
// 			fireHome=true;
// 				/*}
// 			}*/
// 		}
